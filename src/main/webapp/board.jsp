   ...
   <div class="container">
    <div class="head">
        ...
        <div id="tab-button-nav">
          <div class="tab-button" data-tab-section="tab-section-1">공지글</div>
          <div class="tab-button" data-tab-section="tab-section-2">관리자글</div>
        </div>
      </div>
        ...
        <div class="btn">
           ...
           <br>
           <a href="list.jsp"class="btn"><input type="button" name="" value="도서 관리 페이지"></a>
        </div>
  </div>
  </div>
	<!-- 푸터 -->
